...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--image', default='./output/0000027811.jpg',
                                 help='path to image for detecting')
        self.parser.add_argument('--load_model', default='../model_weight/centernet-visdrone/resnet50.pth',
        ...
        # input
        self.parser.add_argument('--input_h', type=int, default=960,#960
                                 help='input height')
        self.parser.add_argument('--input_w', type=int, default=1280,#1280
                                 help='input width')
