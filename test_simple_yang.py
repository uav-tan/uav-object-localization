...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        filenames = readlines(os.path.join(splits_dir, opt.eval_split, "my_pic_files.txt"))
        ...
        dataset = datasets.UAVDataset(opt.data_path, filenames,
                                           encoder_dict['height'], encoder_dict['width'],
                                           [0], 4, is_train=False, img_ext=img_ext)
    ...
    for i in range(pred_disps.shape[0]):
        ...
        np.save('./output/result.npy', pred_depth)
        ...
        name_dest_im = './output/result.jpg'
